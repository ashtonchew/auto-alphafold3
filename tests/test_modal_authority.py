...
def test_modal_authority_writes_readiness_proof_from_live_payload(tmp_path: Path) -> None:
    ...
    assert payload["runtime_capabilities"]["post_training_sampler_selection"] is True
    assert payload["runtime_capabilities"]["post_training_sampler_schedule"] is True
    assert payload["runtime_capabilities"]["post_training_sampler_locality_guard"] is True
